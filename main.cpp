...
void page()
{
	...
	drawlargestring(125, 420, "Room Simulation ");
    ...
    drawstring(100, 175, "NAME : Shravani V");
	drawstring(100, 150, "USN : 1BY19CS144");
	drawstring(100, 125, "SEM : VI");

	drawstring(200, 175, "NAME : Syed Tabraiz");
	drawstring(200, 150, "USN : 1BY19CS165");
	drawstring(200, 125, "SEM : VI");

	drawstring(300, 175, "NAME : Vishal Hanuman");
	drawstring(300, 150, "USN : 1BY19CS182");
...
int main (int argc, char **argv)
{
   ...
   //lutKeyboardFunc(myKeyboardFunc);
